...
<!--
<div class="alert alert-success" role="alert"><i class="fa fa-download fa-lg"></i>数据文件为'<samp>H1N1pdm_2009.nex</samp>' ，可以在此处下载分享的文件:<br />
 <div style="margin: 16px"><samp>Tutorials\Tutorial 2 - Phylodynamics\Data\H1N1pdm_2009.nex</samp></div>
 <a href="{{ root_url }}files/H1N1pdm_2009.nex">可以在此处下载</a>.</div>
-->
...
<!--
<div class="alert alert-success" role="alert"><i class="fa fa-download fa-lg"></i>运行更长代次的log文件可以在分享的文件夹中找到:<br />
...
<!--
<div class="alert alert-success" role="alert"><i class="fa fa-download fa-lg"></i>数据文件为'<samp>NewYork.HA.2000-2003.nex</samp>'可以在分享的文件夹找到:<br />
 <div style="margin: 16px"><code>Tutorials\Tutorial 2 - Phylodynamics\Data\NewYork.HA.2000-2003.nex</code></div>
 <a href="{{ root_url }}files/NewYork.HA.2000-2003.nex">也可以在此处下载</a>.</div>
-->
